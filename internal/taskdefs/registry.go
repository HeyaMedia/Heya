...
var definitions = []Definition{
	{ID: "scan_libraries", KickoffKind: "kickoff_library_scan", WorkKinds: []string{"process_scan", "fetch_metadata", "apply_metadata", "ffprobe", "scan_keyframes", "enrich_media_item", "detect_local_assets", "scan_track_fingerprint", "scan_track_loudness", "scan_album_loudness", "analyze_track_facets", "refresh_artist_centroids", "refresh_album_centroids"}},
