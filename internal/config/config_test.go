...
func TestLoadDefaults(t *testing.T) {
	...
	assert.Equal(t, 50, cfg.Jobs.Workers["search_metadata"].Value)
	assert.Equal(t, 50, cfg.Jobs.Workers["search_metadata_poll"].Value)
	assert.Equal(t, 50, cfg.Jobs.Workers["fetch_metadata"].Value)
	assert.Equal(t, 50, cfg.Jobs.Workers["fetch_metadata_poll"].Value)
