...
FROM agg
JOIN LATERAL (
  SELECT local_mi.id, local_mi.library_id, local_mi.media_type, local_mi.title, local_mi.sort_title, local_mi.year, local_mi.description, local_mi.poster_path, local_mi.backdrop_path, local_mi.external_ids, local_mi.slug, local_mi.homepage, local_mi.tagline, local_mi.original_title, local_mi.original_language, local_mi.status, local_mi.provider_kind, local_mi.heya_slug, local_mi.heya_enriched_at, local_mi.metadata_refreshed_at, local_mi.created_at, local_mi.updated_at, local_mi.search_vector, local_mi.matched_at, local_mi.enrichment_status, local_mi.base_enriched_at, local_mi.people_enriched_at, local_mi.extras_enriched_at, local_mi.images_enriched_at, local_mi.structure_enriched_at, local_mi.last_enrich_attempt_at, local_mi.last_enrich_error, local_mi.field_provenance, local_mi.match_confidence, local_mi.slug_locked, local_mi.public_id
