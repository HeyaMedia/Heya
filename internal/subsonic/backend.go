...
type Backend interface {
	...
	// Per-user state.
	ListUserRatedTracks(ctx context.Context, userID int64, minRating, maxRating int16, limit, offset int32) (*service.MusicListPage[sqlc.ListUserRatedTracksRow], error)
	ListUserRatedArtists(ctx context.Context, userID int64, minRating, maxRating int16, limit, offset int32) (*service.MusicListPage[sqlc.ListUserRatedArtistsRow], error)
	ListUserRatedAlbums(ctx context.Context, userID int64, minRating, maxRating int16, limit, offset int32) (*service.MusicListPage[sqlc.ListUserRatedAlbumsRow], error)
