      ...
      <div class="mf-card">
        ...
        <div class="mf-grid">
          ...
          <div class="mf-field">
            ...
            <div class="mf-readonly">{{ episode?.season?.season_number ?? '—' }}</div>
          </div>
          <div class="mf-field">
            <label class="mf-label">Episode</label>
          ...
          <div class="mf-field">
            ...
            <div class="mf-readonly">{{ episode?.episode?.rating ?? '—' }}</div>
          </div>
          <div class="mf-field">
            <label class="mf-label">Absolute #</label>
            <div class="mf-readonly">{{ (episode?.episode as any)?.absolute_number ?? '—' }}</div>
          </div>
        </div>
      </div>
    </div>
